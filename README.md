# Mentoring
    ...
    // ----------------- 26/09
    1. зарегать юзера на сайте, из почты нажать на конфирмейшн линк. залогиниться и проверить имя юзера
    - имя юзера, имейл уникальный
    - алиас для гмейл ящика - чтоб на один имейл приходили письма со всех
    2. Theory: Exceptions
    3. Null pointer - почему плохо возвращать и как отлавливать - способы

    дженерик: метод, класс, переменная, интерфейс
